...
UserChecker::UserNotConnect($r->generate('login'));
    ...
    $crumb
        ...
        ->addCrumb('Profile', $r->generate('account'));
    ...
    if(!empty($_POST)) {
        ...
        if(!$affilier) {
            ...
            $matricule = "ddhd";
            Flash::flash('success', "Affiliation réussie. Votre matricule est : " . $matricule);
        } else {
            Flash::flash('normal', "Votre affiliation est toujours en cours");
        }
